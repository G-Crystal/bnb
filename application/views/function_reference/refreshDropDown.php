	...
	<div class="row">
		<div class="functions col-xs-9">
			<div>
				...
				<p class="text-muted h-space"> Refresh or update Dropdown if any changes or additional data in list.</p>
				<p class="text-muted h-space"> Menu data can be found in <span class="text-primary">tbl_menus</span>.</p>
			</div>
			<div>
				<h2 id="usage">Usage</h2>
				<div class="hr hr-dotted hr-2"></div>
				<p class="text-success h-space"> $.( <span class="text-warning">'selector'</span> ).refreshDropDown( name, selected, output, options );</p>
			</div>
			<div>
			...
			<div>
				...
				<div class="hr hr-dotted hr-2"></div>
				<p class="text-muted">$.fn.refreshDropDown() is located in <span class="text-success">assest/js/js_helper.js</span></p>
			</div>
		</div>
