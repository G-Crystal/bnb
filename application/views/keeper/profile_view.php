						...
						<div id="home" class="tab-pane in active">
							<div class="row">
								<div class="col-xs-12 col-sm-3 center">
									...
									<button id="reject" class="btn btn-white btn-danger" type="button">Reject</button>
								...
								<div class="col-xs-12 col-sm-9">
									...
									<div class="profile-user-info">
										...
										<div class="profile-info-row">
											<div class="profile-info-name"> Suburbs </div>

											<div class="profile-info-value">
												<span id="suburbs"><?php echo isset($users['personal']->suburbs) ? arrayToList($users['personal']->suburbs,', ',true): ''; ?></span>
											</div>
										</div>
									</div>
...
<script type="text/javascript">
	jQuery(function($) {
		...
		$('#reject').click(function(){
			$.post('keeper/profile/reject',{id:keeper_id})
				.done(function(res){
					if( res == 'success' ){
						$.gritter.add({
							// (string | mandatory) the heading of the notification
		...
		var suburbs = [];
	    $.each(<?php echo json_encode($franchise) ?>, function(k, v) {
	        suburbs.push({id: k, text: v});
	    });
